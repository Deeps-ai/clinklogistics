  ...
  return (
    <div className="md:hidden border-t border-border bg-background/95 backdrop-blur-lg">
      <nav className="container-x py-6 flex flex-col gap-4 text-sm">
        ...
        <Link to="/" hash="about" onClick={onClose} className="flex items-center justify-between py-2 hover:text-ember transition-colors"><span>About</span><span className="text-muted-foreground">→</span></Link>
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="container-x py-24 md:py-32">
        ...
        <ul className="grid md:grid-cols-2 border-t border-l border-border">
          {pillars.map((p) => (
            <li key={p.n} className="group border-r border-b border-border p-8 md:p-10 hover:bg-navy-deep dark:hover:bg-navy hover:text-background dark:hover:text-foreground transition-colors">
    ...
    <header className="sticky top-0 z-50 border-b border-border/60 bg-background/80 backdrop-blur-md">
      <div className="container-x flex h-16 items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            Request a Quote <span aria-hidden className="arrow-slide">→</span>
          </Link>
          <button
...
href="mailto:shatru@clinkshipping.com"
                className="inline-flex items-center gap-2 rounded-sm bg-background px-3 py-2 text-xs font-medium tracking-wide text-foreground hover:bg-ember hover:text-background transition-colors"
              >
